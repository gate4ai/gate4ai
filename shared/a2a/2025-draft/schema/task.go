...
type Task struct {
	...
	// The current status of the task. (Required)
	Status TaskStatus `json:"status"`
	// List of artifacts generated by the task (e.g., files, results). Null or empty if no artifacts yet.
	Artifacts []Artifact `json:"artifacts,omitempty"`
	// Optional: History of messages exchanged for this task (populated if historyLength requested). Null or empty if not requested or not available.
