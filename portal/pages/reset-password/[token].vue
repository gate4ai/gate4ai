  ...
  <v-row justify="center" align="center" class="auth-container">
    <v-col cols="12" sm="8" md="6" lg="4">
      <v-card class="pa-4">
        ...
        <v-form v-if="!resetSuccess" ref="form" @submit.prevent="handlePasswordReset">
          <v-card-text>
            ...
            />
             ...
             <v-text-field
                ...
                :type="showPassword ? 'text' : 'password'"
                required
                :rules="[rules.required, v => v === newPassword || 'Passwords do not match']"
                variant="outlined"
        ...
        <div v-else class="pa-4 text-center">
           <v-icon color="success" size="x-large" class="mb-4">mdi-check-circle-outline</v-icon>
