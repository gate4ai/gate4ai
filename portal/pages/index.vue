    ...
    <v-row class="hero-section py-12">
      <v-col class="d-flex flex-column justify-center">
        ...
        <p v-else class="text-body-1">
          No public servers available in the catalog yet.
        </p>

        <div class="mt-4">
          <v-btn color="primary" class="mr-4" to="/servers"
            >Explore Catalog</v-btn
          >
    ...
    <v-row class="py-12">
      <v-col cols="12" class="text-center mb-8">
        <h2 class="text-h4 font-weight-bold">
          Features for Centralized AI Integration Management
        </h2>
      </v-col>
      ...
      <v-col cols="12" md="4">
        <v-card height="100%">
          ...
          <v-card-text>
            Granular control over A2A/MCP expenses. Set request, token, or cost
            quotas per user/project/team with real-time monitoring.
          </v-card-text>
        </v-card>
      </v-col>
      ...
      <v-col cols="12" md="4">
        <v-card height="100%">
          ...
          <v-card-text>
            Define and enforce security rules centrally. Manage provider
            allow/deny lists, role-based access control (RBAC), and model usage
            policies.
          </v-card-text>
        </v-card>
      </v-col>
      ...
      <v-col cols="12" md="4">
        <v-card height="100%">
          ...
          <v-card-text>
            Detailed logging of all interactions (who, what, when, provider,
            result). Generate usage reports for compliance and insights.
          </v-card-text>
        </v-card>
      </v-col>
      ...
      <v-col cols="12" md="4">
        <v-card height="100%">
          ...
          <v-card-text>
            Connect, configure, and manage credentials for multiple A2A/MCP
            providers through a single, unified gateway interface.
          </v-card-text>
        </v-card>
      </v-col>
      ...
      <v-col cols="12" md="4">
        <v-card height="100%">
          ...
          <v-card-text>
            Prevent abuse and manage load by setting request frequency limits
            (req/sec, req/min) per user, API key, or provider.
          </v-card-text>
        </v-card>
      </v-col>
      ...
      <v-col cols="12" md="4">
        <v-card height="100%">
          ...
          <v-card-text>
            Inject contextual data (like user IDs, roles, app keys) into
            requests to enable finer-grained agent decisions and access control.
          </v-card-text>
        </v-card>
      </v-col>
      ...
      <v-col cols="12" class="text-center">
        <h2 class="text-h4 font-weight-bold mb-3">
          ...
          >
          Use in the Cloud or Install On-Premise
        </h2>
        <p class="text-body-1 text-medium-emphasis">
          Choose the deployment option that best suits your needs – leverage our
          hosted solution or deploy gate4.ai within your own infrastructure.
        </p>
      </v-col>
    </v-row>
  </div>
